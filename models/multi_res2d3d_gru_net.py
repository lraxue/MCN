...
class MultiResidual2D3DGRUNet(Net):
    def network_definition(self):
        ...
        res3d5 = AddLayer(conv3d5c, rect3d5b)

        print("rect3d5b: ", rect3d5b.output_shape)
        ...
        res3d4 = AddLayer(conv3d4c, rect3d4b)

        print("rect3d4b: ", rect3d4b.output_shape)
        ...
        res3d3 = AddLayer(conv3d3c, rect3d3b)

        print("rect3d3b: ", rect3d3b.output_shape)
